...
" Date:		May 03, 2016 - Aug 31, 2022
" Version:	25w	 ASTRO-ONLY
"
...
"  Decho "(ManPageView) done parsing input arguments for topic and booknumber"
  ...
  if !exists("topic") || topic == ""
   ...
   echohl None
   sleep 2
   if &lz != l:keeplz|let &lz= l:keeplz|endif
